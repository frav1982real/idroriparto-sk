...
class RipartoScreen extends StatelessWidget {
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    if (bolletta.numero.isNotEmpty) StatusPill(label: bolletta.numero),
                  ],
                ),
                ...
                AppCard(
                  child: Column(
                    children: [
                      _tot('Quote fisse', rip.totaleFisso),
                      _tot('Consumi individuali', rip.totaleConsumo),
                      _tot('Parti comuni e perdite', rip.totaleComune),
                      _tot('IVA e altro', rip.totaleExtra),
                      const Divider(),
                      _tot('Totale', rip.totaleGenerale, bold: true),
                    ],
                  ),
                ),
                const SizedBox(height: 22),
                Wrap(
                  ...
                  children: [
                    SkButton.primary(
                      onPressed: () => PdfService.shareRiparto(
                        condominio: condo,
                        bolletta: bolletta,
                        riparto: rip,
                      ),
                    ...
                    SkButton(
                      onPressed: () => PdfService.printRiparto(
                        condominio: condo,
                        bolletta: bolletta,
                        riparto: rip,
                      ),
                    ...
                    if (bolletta.stato != StatoBolletta.chiusa)
                      SkButton.secondary(
                        onPressed: () async {
                          await StoreScope.read(context).chiudiBolletta(bolletta.id);
                          if (context.mounted) {
  ...
  Widget _tot(String l, double v, {bool bold = false}) {
    return Padding(
      ...
      builder: (context, ctrl) {
        return ListView(
          ...
          children: [
            ...
            const SizedBox(height: 6),
            Text(
              'Utile in assemblea per mostrare l’effetto del passaggio ai contatori o alle teste.',
              style: Theme.of(context).textTheme.bodySmall,
            ),
            const SizedBox(height: 16),
            SingleChildScrollView(
              ...
              child: DataTable(
                ...
                columns: const [
                  ...
                  DataColumn(label: Text('Millesimi'), numeric: true),
