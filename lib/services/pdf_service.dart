...
class PdfService {
  ...
  static Future<Uint8List> buildRiparto({
    ...
    final teal = PdfColor.fromHex('0F6E6B');
    final deep = PdfColor.fromHex('0A3A42');
    final line = PdfColor.fromHex('D5DEDF');
    final paper = PdfColor.fromHex('F6F2EA');
    final muted = PdfColor.fromHex('5A6B71');
